/**
 * /column/houmon-shika-hajimekata
 * ------------------------------------------------------------------
 * 公開時から /column（単数形）の URL で運用している記事。
 * URL は変更せず、本文・デザイン・編集基準はほかのコラムと同じにしている。
 * 本文と記事情報は lib/columns/houmon-shika-hajimekata.tsx にある。
 */

import type { Metadata } from "next";
import ArticleLayout from "@/components/ArticleLayout";
import { Body, meta } from "@/lib/columns/houmon-shika-hajimekata";
...
export default function HoumonShikaHajimekata() {
  return (
